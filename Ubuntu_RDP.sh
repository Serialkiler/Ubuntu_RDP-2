...
# - Date: 28 June 2023
#
#       * Changes for V0.9 (20230627) - make it clear that 'xfce' Desktop Environment is not ready.
#       * Changes for V1.0 (20230628) - make it clear that 'xfce' desktop environment is now ready.
#
# ***************************************************************************************
